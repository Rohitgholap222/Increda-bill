...
//            System.out.println("Query Fetched");
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 380, 500, 150));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        int  bId = Integer.parseInt(jTextField13.getText());
        ...
        int billid=rd.nextInt(1000);
        paid_amount=Double.parseDouble(jTextField11.getText());
        
       
       double  pend_amount=Double.parseDouble(jTextField12.getText());
        ...
        try {
            ...
            pst.setInt(7, pId);
            pst.setString(8, pname);
                        pst.setInt(9, rate);
                        pst.setString(10, desc);
                        pst.setInt(11, quantity);
                         pst.setDouble(12, paid_amount);
                          pst.setDouble(13, pend_amount);
                           pst.setDouble(14, Total);
                           pst.executeUpdate();
        ...
        String path = "C:\\Users\\Shree\\Desktop\\project_bill\\bill";
        if ( pname.equals("")  && desc.equals("")) {
            ...
            try {
                ...
                doc.open();
                Paragraph paragraph1 = new Paragraph("                                                    KKwagh (It's Your Bill)\n                                 Contact Number: (+91) 8551987988\n\n");
                doc.add(paragraph1);
                doc.open();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String r=jTextField7.getText().trim();
    ...
    private void jTextField11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextField11ActionPerformed
        ...
        int pendamt = finalTotal-z;
        if (finalTotal <= 0) {
            JOptionPane.showMessageDialog(null, "Insufficient amount paid");
            jTextField12.setText(null);
        } else {
            
            jTextField12.setText(Integer.toString(pendamt));
